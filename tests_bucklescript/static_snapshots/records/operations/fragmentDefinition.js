...
var GraphQLPPX = require("../utils/graphQLPPX.bs.js");
...
function serialize$2(value) {
  ...
  var l4 = [serialize(value$1.listFragment)].reduce(GraphQLPPX.deepMerge, {
  ...
  var l2 = [
    ...
    ].reduce(GraphQLPPX.deepMerge, (function (prim) {
          return { };
        }));
